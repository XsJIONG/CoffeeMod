...
public class Host extends Modable {
	...
	public static final void explode(double x, double y, double z, double r, boolean fire) {ScriptManager.nativeExplode((float) x, (float) y, (float) z, (float) r, fire, true, Float.POSITIVE_INFINITY);}
