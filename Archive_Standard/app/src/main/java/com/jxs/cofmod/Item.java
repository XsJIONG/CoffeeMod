...
public class Item extends Modable {
	...
	//固定函数
	public static final void addCraftRecipe(int p1, int p2, int p3, Object p4) {}
	public static final void addFurnaceRecipe(int p1, int p2, int p3) {}
	public static final void addShapedRecipe(int p1, int p2, int p3, Object p4, Object p5) {}
